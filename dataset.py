...
def preprocessing():
    ...
    for key in num_classes:
        ...
        class_files_training = class_files[: int(len(class_files)*.80)] # get 66% class images fo training
        class_files_testing = class_files[int(len(class_files)*.80)+1 :] # get 33% class images fo testing
